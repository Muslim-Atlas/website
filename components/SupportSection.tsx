...
export const SupportSection = () => {
  return (
    <section id="support" className="relative py-24 md:py-32 xl:py-0 xl:min-h-[85vh] 2xl:min-h-[95vh] xl:flex xl:items-center px-6 border-t border-black/5 bg-white/40 z-10">
